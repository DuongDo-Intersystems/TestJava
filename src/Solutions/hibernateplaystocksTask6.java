...
public class hibernateplaystocksTask6 {
	...
	public static void main(String[] args) {
		...
		hibernateplaystocksTask6 driver = new hibernateplaystocksTask6();
        driver.setup();
      ...
      //Starting interactive prompt
		...
		while (active) {
			...
			case "2":
				...
				break;
			case "3":
				System.out.print("Find trader for which ID? ");
				Long personID = scanner.nextLong();
				driver.getTraderTrades(personID);
				break;
			case "4":
				System.out.print("Find all traders with which last name? ");
				String personName = scanner.next();
				driver.query(personName);
				break;
			case "5":
    ...
    protected void displayLeaderboard(){
    	...
    	String hql = "select t.trader, sum((s.close-t.purchasePrice)*shares) as gain, " + 
    				...
    				"from Solutions.Demo.Trade2 as t left join Solutions.Demo.Stock as s on t.stockName = s.stockName " +
